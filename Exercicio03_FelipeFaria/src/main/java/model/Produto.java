...
public class Produto implements Serializable {
	...
	public void setDataFabricacao(LocalDateTime dataFabricacao) {
		...
		if (agora.compareTo(dataFabricacao) >= 0) // Garante que a data de fabricação não pode ser futura
	...
	/* Método sobreposto da classe Object. É executado quando um objeto precisa ser exibido na forma de String. */
	@Override
